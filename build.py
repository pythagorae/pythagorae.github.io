...
T = {
    "en": {
        ...
        "caps": [
            ...
            ("local", "Local &amp; sovereign LLM inference", "Open language models on your own hardware, or on infrastructure we manage for you &mdash; served with an open-source stack you can audit, so privacy is verifiable. GPU sizing, quantization, fine-tuning. Private, sovereign, cost-controlled."),
